...
public class TraderSystem {
    ...
    static final String RESOURCE_PATH = "tradersystem/src/main/resources/";
    ...
    public void run() {
        try {
            ...
            frame.setIconImage(new ImageIcon("tradersystem/src/main/resources/mainIcon.png").getImage());
